    ...
    return (
        <Main>
            ...
            <Section>
                ...
                <div className="flex justify-center w-full bg-white text-neutral-800 lg:mt-[375px] sm:mt-[900px]">
                    {myClasses.length > 0 ? (
                        <div className="flex flex-wrap mx-6 gap-4 h-full w-full sm:justify-center">
                            <span className="fixed top-4 right-6 text-neutral-800 cursor-pointer p-2 rounded-full hover:bg-neutral-200" onClick={openModal}>
