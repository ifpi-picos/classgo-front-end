...
export default function ClassDiary({myClass}) {
    ...
    const getLessonsUrl = `https://idcurso-back-end.vercel.app/lessons/all/${classId}`
    ...
    const updateLesson = (e) => {
        ...
        axios
            .patch(updateLessonUrl, {description, date, classId}, {headers: {
                "Accept": "application/json",
                "Content-Type": "application/json",
                "Authorization": localStorage.getItem("token")
            }})
